...
class NeuralNetMLP:
    ...
    def __init__(self, num_features, num_hidden, num_classes, random_seed=123, minibatch_size=100):
        super().__init__()
    ...
    def train(self, X_train, y_train, X_valid, y_valid, num_epochs, learning_rate=0.1):
        ...
        for e in range(num_epochs):
            ...
            for X_train_mini, y_train_mini in minibatch_gen:
                ...
                d_loss__d_w_out, d_loss__d_b_out, d_loss__d_w_h, d_loss__d_b_h = \
                    self.backward(X_train_mini, a_h, a_out, y_train_mini)
        ...
        return epoch_loss, epoch_loss_valid, epoch_train_acc, epoch_valid_acc